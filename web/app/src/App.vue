...
body {
  &:before {
    ...
    display: block;
    background: no-repeat right top/auto 70% url("../src/assets/bg/bg-blue-light.svg"), no-repeat left top/auto 80% url("../src/assets/bg/bg-red.svg"), no-repeat center center/contain url("/img/bg/team2018.jpg");
    width: 100%;
    height: 100%;
  }
}
...
@media screen and (max-width: $tablet) {
  body {
    &:before {
      ...
      display: block;
      background: no-repeat right top/auto 40% url("../src/assets/bg/bg-blue-light.svg"), no-repeat left top/auto 80% url("../src/assets/bg/bg-red.svg"), no-repeat center center/contain url("/img/bg/team2018.jpg");
      width: 100%;
      height: 100%;
    }
  }
