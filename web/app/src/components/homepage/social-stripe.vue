  ...
  <div class="home-component social-stripe-wrapper">
    <div class="container social-stripe-container">
      ...
      <div class="icon-wrapper">
        ...
        <!-- Meetup -->
        <a href="https://www.meetup.com/MauritiusSoftwareCraftsmanshipCommunity/" target="_blank">
        ...
        <a href="https://www.linkedin.com/groups/5033639/" target="_blank">
          ...
          <!-- YouTube  -->
        <a href="https://www.youtube.com/channel/UCeLiAZ5TlJla_uDj8_KndyA" target="_blank">
          <svg class="icon" viewBox="0 0 512 512">
            <path
