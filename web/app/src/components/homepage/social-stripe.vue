  ...
  <div class="home-component social-stripe-wrapper">
    <div class="container social-stripe-container">
      ...
      <div class="icon-wrapper">
        ...
        <!-- YouTube  -->
        <a href="https://www.youtube.com/channel/UCeLiAZ5TlJla_uDj8_KndyA"
          target="_blank" rel="noopener noreferrer" class="youtube">
          <svg class="icon" viewBox="0 0 512 512">
