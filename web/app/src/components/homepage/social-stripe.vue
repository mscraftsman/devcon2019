  ...
  <div class="home-component social-stripe-wrapper">
    <div class="container social-stripe-container">
      ...
      <div class="icon-wrapper">
        <!-- Meetup -->
        <a href="https://www.meetup.com/MauritiusSoftwareCraftsmanshipCommunity/" target="_blank" rel="noopener noreferrer">
        ...
        <!-- Facebook -->
        <a href="https://www.facebook.com/MauritiusSoftwareCraftsmanshipCommunity/" target="_blank" rel="noopener noreferrer">
        ...
        <!-- Twitter -->
        <a href="https://twitter.com/MSCraftsman" target="_blank" rel="noopener noreferrer">
          <svg class="icon" viewBox="0 0 512 512">
            <path
        ...
        <!-- Linkedin -->
        <a href="https://www.linkedin.com/groups/5033639/" target="_blank" rel="noopener noreferrer">
          <svg class="icon" viewBox="0 0 512 512">
            <path
          ...
          <!-- YouTube  -->
        <a href="https://www.youtube.com/channel/UCeLiAZ5TlJla_uDj8_KndyA" target="_blank" rel="noopener noreferrer">
          <svg class="icon" viewBox="0 0 512 512">
            <path
