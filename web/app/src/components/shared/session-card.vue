<template>
  <div class="session-card" :class="isWorkshop ? 'workshop' : ''">
    <div class="session-title" @click="goToSession(session.id)">{{
      session.title | truncate(80, "...") }}</div>
    <div class="session-description" @click="goToSession(session.id)">{{
      session.description | truncatePointPoint(120, "...") }}</div>
    <div class="session-author" v-if="session.speakers.length > 0">
      ...
      <div class="vote-button saved" title="Rated !" v-if="voted">
        <svg width="60" height="44" viewBox="0 0 60 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.5714 0H49.1606C54.5453 0 58.3923 5.21239 56.8052 10.3579L48.1688 38.3579C47.1343 41.712 44.0342 44 40.5242 44H0L13.5714 0Z"
            fill="var(--color-vote)" />
          <path d="M25 32H22C21.4696 32 20.9609 31.7893 20.5858 31.4142C20.2107 31.0391 20 30.5304 20 30V23C20 22.4696 20.2107 21.9609 20.5858 21.5858C20.9609 21.2107 21.4696 21 22 21H25M32 19V15C32 14.2044 31.6839 13.4413 31.1213 12.8787C30.5587 12.3161 29.7956 12 29 12L25 21V32H36.28C36.7623 32.0055 37.2304 31.8364 37.5979 31.524C37.9654 31.2116 38.2077 30.7769 38.28 30.3L39.66 21.3C39.7035 21.0134 39.6842 20.7207 39.6033 20.4423C39.5225 20.1638 39.3821 19.9063 39.1919 19.6875C39.0016 19.4687 38.7661 19.2939 38.5016 19.1752C38.2371 19.0565 37.9499 18.9967 37.66 19H32Z"
      ...
      <div class="vote-button" v-else>
        <svg width="60" height="44" viewBox="0 0 60 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.5714 0H49.1606C54.5453 0 58.3923 5.21239 56.8052 10.3579L48.1688 38.3579C47.1343 41.712 44.0342 44 40.5242 44H0L13.5714 0Z"
            fill="var(--color-vote)" />
          <path d="M30 32C35.5228 32 40 27.5228 40 22C40 16.4772 35.5228 12 30 12C24.4772 12 20 16.4772 20 22C20 27.5228 24.4772 32 30 32Z"
            stroke="white" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="bevel" />
          <path d="M27.09 19C27.3251 18.3317 27.7891 17.7681 28.4 17.4091C29.0108 17.0501 29.7289 16.9189 30.4272 17.0387C31.1255 17.1585 31.7588 17.5215 32.2151 18.0635C32.6713 18.6055 32.9211 19.2915 32.92 20C32.92 22 29.92 23 29.92 23"
            stroke="white" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="bevel" />
